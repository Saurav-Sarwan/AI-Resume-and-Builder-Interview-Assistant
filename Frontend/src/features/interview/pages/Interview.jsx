...
const Interview = () => {
    ...
    return (
        <div className='interview-page'>
            <button className='button logout-button interview-logout-button' onClick={handleLogoutClick}>Logout</button>
